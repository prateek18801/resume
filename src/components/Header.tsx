    ...
    return (
        <div className="flex flex-col justify-between mb-5 md:flex-row print:flex-row">
            ...
            <div className="flex flex-col">
                <a className="flex mb-1 font-medium hover:underline md:mt-7 print:mt-7" href="https://github.com/prateek18801/" target="_blank">
                    <FaGithub className="my-auto mr-1 text-accent-color" />
                    <div>github.com/prateek18801</div>
                </a>
                <a className="flex mb-1 font-medium hover:underline" href="https://linkedin.com/in/prateekchaurasia/" target="_blank">
